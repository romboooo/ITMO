...
public class AddIfMaxCommand extends DataBaseCommand implements Executable {
    ...
    public AddIfMaxCommand(DataBase dataBase, CommandProcessor commandProcessor) {
    ...
    public String ExecuteCommand(String... args) {
        try {
            ...
            if (Long.valueOf(price) <= Collections.max(prices)) {
                return "The price you entered is not the maximum element of the ticket collection, enter \"print_field_descending_price\" for view a price info ";
            }

            System.out.println("price you entered is bigger than max of prices, you can add a ticket: ");
